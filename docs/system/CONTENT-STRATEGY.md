...
Current downstream consumer: Phase 02 — Content Model Contract + Bootstrap Migration — ACTIVE / Batch 02.6 BLOCKED PENDING FRESH GATE A
...
- Phase 02 — Content Model Contract + Bootstrap Migration, active; Batch 02.5 re-approved after compatibility correction and Batch 02.6 blocked pending fresh Gate A
